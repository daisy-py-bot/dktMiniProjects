...
public class GenerateRandomPassword {
    ...
    public static void main(String[] args){
        ...
        String passwordCheck = checkPassword(minPasswordLen, minNumOfUpperCase, minNumOfDigits, minNumOfSpecialChar, specialChars, password);
    ...
    // check the password
    public static String checkPassword(int minPasswordLen, int minNumOfUpperCase, int minNumOfDigits, int minNumOfSpecialChar, String specialChars, String password){
        int countUpperCase = 0;
        int countDigits = 0;
        int countSpecialChar = 0;
        ...
        // chacking the inner requirements of the password
